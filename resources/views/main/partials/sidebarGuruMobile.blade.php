<div class="lg:hidden">
  ...
  <div class="absolute lg:fixed lg:left-0 lg:w-[20vw] h-screen w-[55vw] bg-white top-0 -left-[1920px] rounded-r-md border-2 transition-all duration-150">
    ...
    <div class="w-full flex flex-col px-2 py-2 gap-4 lg:mt-12 uppercase">
      <a href="/guru" class="w-full px-4 py-1 text-sm font-bold rounded-md shadow-lg {{ Request::is('guru') ? "bg-orange-primary text-white" : "bg-white text-orange-primary border" }}">Home</a>
      <a href="/guru/profile" class="w-full px-4 py-1 text-sm font-bold rounded-md shadow-lg {{ Request::is('guru/profile') ? "bg-orange-primary text-white" : "bg-white text-orange-primary border" }}">Profil</a>
      <a href="/guru/riwayat" class="w-full px-4 py-1 text-sm font-bold rounded-md shadow-lg {{ Request::is('guru/riwayat') ? "bg-orange-primary text-white" : "bg-white text-orange-primary border" }}">Riwayat</a>
